...
| Auto Approval Delay  |    same     |       no | How long (*in seconds*) after Worker submits a HIT it should be automatically approved and the Worker paid. Setting this to a short value is can be good [Requestor etiquette](etiquette.md) so Workers aren't waiting to get paid.                                                                                                                                                                                                                                                                                                                                                   |
...
| Repeat Participation |    HITs     |      yes | How many times any given Worker can complete and submit your HIT for payment. Ust it in conjunction with the Unique Workers input. For more details see [below](#repeat-participation-unique-workers-and-mturk-fees).                                                                                                                                                                                                                                                                                                                                                                 |
