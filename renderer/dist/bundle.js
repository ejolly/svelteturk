...
/* renderer/src/components/App.svelte generated by Svelte v3.24.0 */

const { console: console_1 } = globals;
const file = "renderer/src/components/App.svelte";
		...
		m: function mount(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					...
					listen_dev(button1, "click", /*clearAll*/ ctx[3], false, false, false),
					listen_dev(button2, "click", /*backup*/ ctx[4], false, false, false),
					listen_dev(form, "submit", prevent_default(/*insert*/ ctx[2]), false, true, false)
				];
...
function instance($$self, $$props, $$invalidate) {
	...
	return [myItems, newItem, insert, clearAll, backup, input_input_handler];
}
